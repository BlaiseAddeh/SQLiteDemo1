...
public class AddUpdateRecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialiser la bar d'action
        actionBar = getSupportActionBar();

        // Donner un titre à la barre d'action
        ...
        // initialiser les tableaux de permissions
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        // result of permission allowed/dinied
        switch (requestCode) {
            case CAMERA_REQUEST_CODE: {
                if (grantResults.length > 0) {
                    ...
                    if (cameraAccepted && storageAccepted) {
                        ...
                        Toast.makeText(this, "Camera & Storage permisions are required", Toast.LENGTH_SHORT).show();
                    }
